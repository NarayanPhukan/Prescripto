  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div className="flex hover:scale-105 transition-all duration-500 flex-row sm:flex-col gap-4 text-sm text-gray-600 overflow-x-auto pb-4 sm:pb-0 hide-scrollbar">
  {[
    "General physician",
    "Gynecologist",
    "Dermatologist",
