  ...
  return (
    <div className="px-4 sm:px-6 md:px-10 py-6">
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5">
        ...
        <div className="flex sm:flex-col gap-3 sm:gap-4 w-full sm:w-48 overflow-x-auto sm:overflow-visible">
          {specialties.map((spec, idx) => (
            <p
              key={idx}
              onClick={() => handleSpecialityClick(spec)}
              className={`flex-shrink-0 w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded-full cursor-pointer text-sm
