  ...
  return (
    <div className="px-4 sm:px-10 md:px-20">
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm md:text-base text-gray-600 leading-relaxed">
          <p>
      ...
      {/* WHY CHOOSE US */}
      <h2 className="text-xl my-6 text-gray-700">
        WHY <span className="font-semibold">CHOOSE US</span>
      </h2>

      <div className="flex flex-col md:flex-row mb-20 gap-4">
        <div className="border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] shadow-sm hover:shadow-lg hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer rounded-lg">
