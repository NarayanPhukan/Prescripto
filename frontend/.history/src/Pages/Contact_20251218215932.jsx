    ...
    <div>
      ...
      <div className="flex my-10 flex-col justify-center md:flex-row gap-10 mb-28 text-sm">
        ...
        <div className="flex flex-col justify-center items-start gap-6 ">
          ...
          <p className=" text-gray-500">54709 Willms Station <br />Suite 350, Washington, USA</p><br />
          <p className=" text-gray-500">Tel: +91-8822361549 <br /> Email: narayanphukan30@gmail.com</p>
