      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div className="flex flex-row sm:flex-col gap-4 text-sm text-gray-600 overflow-x-scroll sm:overflow-y-auto pb-4 sm:pb-0 hide-scrollbar">
          <p
            ...
            className={` hover:scale-105 transition-all duration-500 whitespace-nowrap sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition cursor-pointer ${
              speciality === "General physician"
